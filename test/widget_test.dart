...
void main() {
  ...
  testWidgets('debug catalog does not expose runtime preview toggle', (
    tester,
  ) async {
    final repository = _InMemorySketchRepository();
    ...
    expect(find.byKey(const Key('catalog_debug_overflow')), findsNothing);
